...
export const interpretations: Interpretation[] = [
  ...
  },
  {
    ...
    `Women are higher in openness than men.`,
    ],
  },
  {
    trait: 'Aesthetic Openness',
  ...
  },
  {
    ...
    scoreLevel: 'high',
    paragraphs: [
    `You are high in aesthetic openness, which means you love beauty, art, music, etc.`,
  ...
  },
  {
    ...
    `Women are lower than men in interest in ideas (although not in IQ).`,
  ...
  },
  {
    ...
    `Women are lower than men in their interest in ideas (although not in IQ).`,
    `Note: Do not confuse the personality aspect with IQ. This aspect measures interest in abstract ideas, while IQ is a measure of processing speed, verbal ability, working memory, and problem-solving capacity, and is better measured with a formal IQ test. It is perfectly possible to have a high IQ and a low score on the personality trait of interest in ideas (or the reverse).`,
    ],
  },
  {
  ...
  },
  {
    ...
    `Women are higher in enthusiasm than men.`,
    ],
  },
  {
    trait: 'Enthusiasm',
  ...
  },
  {
    ...
    `Women are slightly less assertive than men.`,
    ],
  },
  {
    trait: 'Assertiveness',
  ...
  },
  {
    ...
    scoreLevel: 'average',
    paragraphs: [
    `You are average in politeness and are deferential to authority.`,
  ...
  },
  {
    ...
    scoreLevel: 'high',
    paragraphs: [
    `You are high in politeness and are obedient and respectful of authority.`,
  ...
  },
  {
    ...
    `Women are higher in withdrawal than men.`,
    ],
  },
  {
    trait: 'Withdrawal',
  ...
  },
  {
    ...
    `Women are higher in volatility than men.`,
    ],
  },
  {
    trait: 'Volatility',
    scoreLevel: 'low',
    paragraphs: [
    `You are low in volatility, which means your mood is very stable.`,
  ...
  },
  {
    ...
    scoreLevel: 'modLow',
    paragraphs: [
    `You are moderately low in volatility, which means your mood is generally stable.`,
    `People low in this trait are not as irritable, strongly affected by disappointment, frustration, pain, or the threat of isolation.`,
    `They are not prone to lash out or be easily annoyed, while they more reasonably express their frustration, disappointment, and irritability. Even if stirred up, upset, angry, irritated, they calm down quickly.`,
    `Being lower in volatility means being less argumentative than average and rarely lose their composure. If overly provoked in a dispute, a person of average volatility may react in kind (particularly if also low in agreeableness). However, such people tend to remain calm and unperturbed, even when stressed.`,
  ...
  },
  {
    ...
    scoreLevel: 'average',
    paragraphs: [
    `You are average in volatility, which means your mood is usually stable.`,
  ...
  },
  {
    ...
    scoreLevel: 'modHigh',
    paragraphs: [
    `You are moderately high in volatility, which means you tend to vary in your mood.`,
